...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIZDhU9i6JgXmB";
    static final String accessKeySecret = "bVvzU6rpOpFH5n2heLQRhvycI9z41i";
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13552379492");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("广州嘉和汽车");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_155425089");
...
//        //必填-号码
//        request.setPhoneNumber("13552379492");
//        //可选-流水号
