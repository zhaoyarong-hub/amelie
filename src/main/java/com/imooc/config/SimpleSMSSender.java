...
import com.imooc.service.ApplicationContextRegister;
import lombok.Data;
...
//        private Query query;
    ...
    public static Result send(SMS sms) {
        SimpleSMSSender simpleSMSSender
                = ApplicationContextRegister.getBean(SimpleSMSSender.class);
        return simpleSMSSender.sendSms(sms);
    }

    public static QuerySendDetailsResponse query(Query query) {
        SimpleSMSSender simpleSMSSender = ApplicationContextRegister.getBean(SimpleSMSSender.class);
